...
document.addEventListener('DOMContentLoaded',()=>{
    ...
    }).type('Engenheiro',{delay: 900}).delete(11)
      .type('Analista de dados',{delay:900}).delete(18)
      .type('Web Designer',{delay:900}).delete(12)
      .type('Freelancer',{delay:900}).delete(10)
      .type('Engenheiro',{delay: 900}).delete(11)
      .type('Analista de dados',{delay:900}).delete(18)
      .type('Web Designer',{delay:900}).delete(12)
      .type('Freelancer',{delay:900}).delete(10)
...
sr.reveal('.about__social-icon', {delay: 300, interval: 50})
